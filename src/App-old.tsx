...
function App() {
  ...
  const handleMarkerClick = (local: Local) => {
    ...
    console.log('📍 Setting localSeleccionado to:', local);
    setLocalSeleccionado(local);
    console.log('✅ State updated');
  };

  console.log('🔍 Current localSeleccionado:', localSeleccionado);
  console.log('🔍 Should show modal?', localSeleccionado !== null);

  return (
    <div className="h-screen bg-gray-900 text-white flex flex-col">
      {/* DEBUG INFO */}
      <div className="fixed top-0 left-0 bg-red-600 text-white p-2 z-[10000] text-xs">
        Local seleccionado: {localSeleccionado ? localSeleccionado.nombre : 'NINGUNO'}
      </div>

      {/* Header */}
      <div className="bg-black/80 backdrop-blur-md border-b border-purple-500/30 p-4 z-10 mt-8">
      ...
      {/* MODAL - Versión más simple posible */}
